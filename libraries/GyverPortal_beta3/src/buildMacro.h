...
#define GP_MAKE_JQ_UPDATE2(name, args) GP.JQ_UPDATE_BEGIN(name); args; GP.JQ_UPDATE_END();
#define GP_MAKE_JQ_UPDATE3(name, prd, args) GP.JQ_UPDATE_BEGIN(name, prd); args; GP.JQ_UPDATE_END();