/*
    ...
    - Полностью переписан конструктор, сборка занимает во много раз меньше памяти в SRAM за счёт отправки страницы частями
    - Чуть увеличилось время сборки и отправки страницы в браузер
